...
function main () {
    ...
    if(Eh_MenorIgual_25(imc)) {
        print (`
        De acordo com o cálculo do IMC, sendo ${imc}. Você está normal.`);
    } else if (Eh_Maior_25_E_Menor_30(imc)) {
        print (`
        De acordo com o cálculo do IMC, sendo ${imc}. Você está obeso.`);
    } else {
        print(`
        De acordo com o cálculo do IMC, sendo ${imc}. Você está com obesidade mórbida.`);
    }
