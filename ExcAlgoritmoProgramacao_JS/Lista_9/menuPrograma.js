...
import { adicionarCliente, consultarCliente, excluirCliente, relatorioClientes, relatorioVendas } from "./funcionabilidades.js";

function main() {
    let opcao = -1, entradas, id, clienteId, vendaId, mensagem;
