...
class App {
    ...
    sacarConta(numeroConta, valorSacar) {
        try {
            ...
            if (error instanceof Validacoes_1.ValorInvalidoError || error instanceof Validacoes_1.ValorVazioError || error instanceof Validacoes_1.NumeroInvalidoError) {
    ...
    validarValor(valor) {
        if (valor <= 0) {
            throw new Validacoes_1.ValorInvalidoError();
        }
        if (isNaN(valor)) {
            throw new Validacoes_1.NumeroInvalidoError();
        }
    }
}
exports.App = App;
