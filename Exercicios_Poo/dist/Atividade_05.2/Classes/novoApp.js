...
exports.App = void 0;
const novoCliente_1 = require("./novoCliente");
const novaConta_1 = require("./novaConta");
...
class App {
    ...
    inserirConta() {
        ...
        let conta = new novaConta_1.Cont(idConta, numeroConta, 0, null);
        if (conta) {
    ...
    inserirCliente() {
        ...
        let cliente = new novoCliente_1.Client(idCliente, nomeCliente, numeroCpf, dataNasci);
        if (cliente) {
...
exports.App = App;
//# sourceMappingURL=novoApp.js.map