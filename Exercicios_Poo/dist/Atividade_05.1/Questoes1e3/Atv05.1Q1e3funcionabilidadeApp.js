...
const Atv05_1Q1e3utils_1 = require("./Atv05.1Q1e3utils");
function inserirConta(banco) {
    let idConta = (0, Atv05_1Q1e3utils_1.get_number)(`\n\rDigite o numero de identificacao(ID) da conta: `);
    let numeroConta = (0, Atv05_1Q1e3utils_1.get_text)(`\n\rDigite o numero da conta: `);
    let conta = new Atv05_1Q1e3classBank_1.Cont(idConta, numeroConta, 0, null);
    if (conta) {
...
function sacarConta(banco) {
    let numeroConta = (0, Atv05_1Q1e3utils_1.get_text)(`\n\rDigite o numero da conta: `);
    let valorSacar = (0, Atv05_1Q1e3utils_1.get_number)(`\n\rDigite o valor que deseja sacar: `);
    let contaProcurada = banco.consultarConta(numeroConta);
    if (contaProcurada) {
        ...
        (0, Atv05_1Q1e3utils_1.print)(`Conta de número ${numeroConta}, não encontrada...`);
    }
}
function depositarConta(banco) {
    let numeroConta = (0, Atv05_1Q1e3utils_1.get_text)(`\n\rDigite o numero da conta: `);
    let valorDeposito = (0, Atv05_1Q1e3utils_1.get_number)(`\n\rDigite o valor que deseja depositar: `);
    let contaProcurada = banco.consultarConta(numeroConta);
    if (contaProcurada) {
...
function transferirEntreContas(banco) {
    ...
    if (remetenteProcurada) {
        ...
        let valorDesejado = (0, Atv05_1Q1e3utils_1.get_number)(`\n\rDigite o valor que deseja depositar: `);
...
function totalizarSaldos(banco) {
    let numeroCpf = (0, Atv05_1Q1e3utils_1.get_text)(`\n\rDigite o numero de CPF do Cliente: `);
...
function inserirCliente(banco) {
    let idCliente = (0, Atv05_1Q1e3utils_1.get_number)(`\n\rDigite o numero de identificacao(ID) do cliente: `);
    let nomeCliente = (0, Atv05_1Q1e3utils_1.get_text)(`\n\rDigite o nome do cliente: `);
    let numeroCpf = (0, Atv05_1Q1e3utils_1.get_text)(`\n\rDigite o numero de CPF do cliente: `);
    let dataNasci = (0, Atv05_1Q1e3utils_1.get_date)(`\n\rDigite a data de aniversario do cliente. EX: (ano, mes, dia): `);
    let cliente = new Atv05_1Q1e3classBank_1.Client(idCliente, nomeCliente, numeroCpf, dataNasci);
    if (cliente) {
...
//# sourceMappingURL=Atv05.1Q1e3funcionabilidadeApp.js.map