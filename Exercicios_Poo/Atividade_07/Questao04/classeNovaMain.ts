...
import { Bank } from "./classeNovoBanco";
import { App } from './classeNovoApp';
import { get_date, get_number, get_text } from './novaUtils';
...
function main() {
    ...
    let nomeCliente: string = '', dataNasci: Date = new Date(), verificação: boolean = false;
